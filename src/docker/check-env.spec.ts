describe('check-env', () => {
    ...
    describe('runEnvChecks with all required variables', () => {
        ...
        it('should log header and footer', () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith(
                '  Whispr Auth Service - Environment Check'
            )
        })
        ...
        it('should check all required variables', () => {
            ...
            requiredVars.forEach((varName) => {
                expect(consoleLogSpy).toHaveBeenCalledWith(
                    expect.stringContaining(`${varName} is set`)
                )
            })
        })
        ...
        it('should warn about missing optional variables', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining(
                    'optional environment variable(s) not set'
                )
            )
        })
    })
    ...
    describe('runEnvChecks with optional variables', () => {
        ...
        it('should log optional variables when set', () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith(
                expect.stringContaining('DB_LOGGING is set')
            )
            expect(consoleLogSpy).toHaveBeenCalledWith(
                expect.stringContaining('LOG_LEVEL is set')
            )
            expect(consoleLogSpy).toHaveBeenCalledWith(
                expect.stringContaining('METRICS_ENABLED is set')
            )
        })
        ...
        it('should still warn about unset optional variables', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('DB_URL is NOT set')
            )
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('REDIS_PASSWORD is NOT set')
            )
        })
    })
    ...
    describe('runEnvChecks with missing required variables', () => {
        ...
        it('should throw error when gRPC service URLs are missing', () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                expect.stringContaining(
                    'USER_SERVICE_GRPC_URL is NOT set (REQUIRED)'
                )
            )
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                expect.stringContaining(
                    'MEDIA_SERVICE_GRPC_URL is NOT set (REQUIRED)'
                )
            )
        })
        ...
        it('should throw error when Twilio variables are missing', () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                expect.stringContaining(
                    'TWILIO_ACCOUNT_SID is NOT set (REQUIRED)'
                )
            )
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                expect.stringContaining(
                    'TWILIO_AUTH_TOKEN is NOT set (REQUIRED)'
                )
            )
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                expect.stringContaining(
                    'TWILIO_FROM_NUMBER is NOT set (REQUIRED)'
                )
            )
        })
    ...
    describe('runEnvChecks with empty string values', () => {
        ...
        it('should treat empty optional variables as missing', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('LOG_LEVEL is NOT set')
            )
        })
    })
    ...
    describe('runEnvChecks output formatting', () => {
        ...
        it('should display default values for optional variables', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('will use default: false')
            )
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('will use default: info')
            )
        })
    })
    ...
    describe('runEnvChecks edge cases', () => {
        ...
        it('should handle numeric values correctly', () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith(
                expect.stringContaining('DB_PORT is set')
            )
            expect(consoleLogSpy).toHaveBeenCalledWith(
                expect.stringContaining('REDIS_PORT is set')
            )
        })
    })
})
