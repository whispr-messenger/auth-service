...
import { parsePhoneNumber } from 'node_modules/libphonenumber-js/index.cjs'
...
export class PhoneVerificationService {
    ...
    async requestRegistrationVerification(
        ...
        const verificationId = await this.requestVerification(
            dto.phoneNumber,
            'registration'
        )
    ...
    async confirmLoginVerification(
        ...
        const verificationData = await this.verifyCode(
            dto.verificationId,
            dto.code
        )
