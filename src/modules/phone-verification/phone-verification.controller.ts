...
export class PhoneVerificationController {
    constructor(
        private readonly phoneVerificationService: PhoneVerificationController
    ) {}
    ...
    async requestRegistrationVerification(@Body() dto: VerificationRequestDto) {
        return this.phoneVerificationService.requestRegistrationVerification(
            dto
        )
    }
    ...
    async confirmRegistrationVerification(@Body() dto: VerificationConfirmDto) {
        return this.phoneVerificationService.confirmRegistrationVerification(
            dto
        )
    }
