...
describe('VerificationService', () => {
    ...
    describe('requestVerification', () => {
        ...
        it('should request verification successfully', async () => {
            ...
            const result = await service.requestVerification(phoneNumber, purpose);
    ...
    describe('verifyCode', () => {
        ...
        it('should throw error for invalid verification ID', async () => {
            ...
            await expect(service.verifyCode(verificationId, code)).rejects.toThrow(BadRequestException);
        });
        ...
        it('should throw error for invalid code', async () => {
            ...
            await expect(service.verifyCode(verificationId, '000000')).rejects.toThrow(BadRequestException);
        });
        ...
        it('should throw error for too many attempts', async () => {
            ...
            await expect(service.verifyCode(verificationId, '000000')).rejects.toThrow(HttpException);
        });
    });
    ...
    describe('consumeVerification', () => {
        it('should consume verification successfully', async () => {
            ...
            expect(mockCacheManager.del).toHaveBeenCalledWith('verification:test-verification-id');
        });
    });
});
