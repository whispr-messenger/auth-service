...
describe('SignalKeysManagementController', () => {
	...
	describe('uploadSignedPreKey', () => {
		it('should upload new signed prekey', async () => {
			...
			expect(rotationService.rotateSignedPreKey).toHaveBeenCalledWith(mockUserId, newSignedPreKey);
		});
	...
	describe('uploadPreKeys', () => {
		it('should upload new prekeys', async () => {
			...
			expect(rotationService.replenishPreKeys).toHaveBeenCalledWith(mockUserId, newPreKeys);
		});
	...
	describe('getRotationRecommendations', () => {
		it('should return rotation recommendations', async () => {
			...
			const result = await controller.getRotationRecommendations(mockUserId);

			expect(result).toEqual(mockRecommendations);
			expect(rotationService.getRotationRecommendations).toHaveBeenCalledWith(mockUserId);
		});
	});
