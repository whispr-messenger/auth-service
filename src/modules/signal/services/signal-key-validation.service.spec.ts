...
describe('SignalKeyValidationService', () => {
	...
	describe('validatePublicKeyFormat', () => {
		...
		it('should reject empty keys', () => {
			expect(() => service.validatePublicKeyFormat('')).toThrow(BadRequestException);
		});

		it('should reject non-string keys', () => {
			expect(() => service.validatePublicKeyFormat(null as any)).toThrow(BadRequestException);
		});

		it('should reject keys with invalid base64 characters', () => {
			expect(() => service.validatePublicKeyFormat('invalid@key!')).toThrow(BadRequestException);
		});

		it('should reject keys that are too short', () => {
			expect(() => service.validatePublicKeyFormat('ABC')).toThrow(BadRequestException);
		});

		it('should reject keys that are too long', () => {
			const tooLong = 'A'.repeat(150);
			expect(() => service.validatePublicKeyFormat(tooLong)).toThrow(BadRequestException);
		});
	});
	...
	describe('validateSignedPreKey', () => {
		...
		it('should reject null signed prekey', () => {
			expect(() => service.validateSignedPreKey(null as any)).toThrow(BadRequestException);
		});
	...
	describe('validatePreKey', () => {
		...
		it('should reject null prekey', () => {
			expect(() => service.validatePreKey(null as any)).toThrow(BadRequestException);
		});
	...
	describe('validatePreKeys', () => {
		...
		it('should reject non-array input', () => {
			expect(() => service.validatePreKeys(null as any)).toThrow(BadRequestException);
		});
	...
	describe('validateIdentityKey', () => {
		...
		it('should reject null identity key', () => {
			expect(() => service.validateIdentityKey(null as any)).toThrow(BadRequestException);
		});

		it('should reject empty identity key', () => {
			expect(() => service.validateIdentityKey('')).toThrow(BadRequestException);
		});
	});
