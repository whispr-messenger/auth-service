...
import { TokenPair } from 'src/modules/tokens/token-pair.interface'
...
export class QuickResponseCodeService {
    ...
    async scanLogin(
        ...
        const challengeData = await this.validateQRChallenge(
            dto.challenge,
        ...
        try {
            ...
            if (decoded.deviceId !== authenticatedDeviceId) {
                throw new ForbiddenException(
                    'Appareil non autorisé pour ce challenge'
                )
            }
