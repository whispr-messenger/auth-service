	...
	private async startGrpcServer() {
		try {
			...
			this.server.addService(authProto.AuthService.service, {
				validateToken: this.authGrpcService.validateToken.bind(this.authGrpcService),
				refreshToken: this.authGrpcService.refreshToken.bind(this.authGrpcService),
				login: this.authGrpcService.login.bind(this.authGrpcService),
				getUserInfo: this.authGrpcService.getUserInfo.bind(this.authGrpcService),
				getUserProfile: this.authGrpcService.getUserProfile.bind(this.authGrpcService),
				checkPermission: this.authGrpcService.checkPermission.bind(this.authGrpcService),
				registerDevice: this.authGrpcService.registerDevice.bind(this.authGrpcService),
				revokeDevice: this.authGrpcService.revokeDevice.bind(this.authGrpcService),
				getUserDevices: this.authGrpcService.getUserDevices.bind(this.authGrpcService),
				verifyTwoFactor: this.authGrpcService.verifyTwoFactor.bind(this.authGrpcService),
				generateQRCode: this.authGrpcService.generateQRCode.bind(this.authGrpcService),
