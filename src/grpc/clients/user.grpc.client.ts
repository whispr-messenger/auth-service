...
export class UserGrpcClient implements OnModuleInit {
	...
	async searchUsers(query: string, limit: number = 10, offset: number = 0): Promise<any> {
		return new Promise((resolve, reject) => {
			if (!this.client) {
				return reject(new Error('gRPC client not initialized'));
			}
	...
	async getUserContacts(userId: string, limit: number = 50, offset: number = 0): Promise<any> {
		return new Promise((resolve, reject) => {
			if (!this.client) {
				return reject(new Error('gRPC client not initialized'));
			}
	...
	async addContact(userId: string, contactUserId: string, displayName?: string): Promise<any> {
		return new Promise((resolve, reject) => {
			if (!this.client) {
				return reject(new Error('gRPC client not initialized'));
			}
	...
	async blockUser(userId: string, blockedUserId: string, reason?: string): Promise<any> {
		return new Promise((resolve, reject) => {
			if (!this.client) {
				return reject(new Error('gRPC client not initialized'));
			}
	...
	async getBlockedUsers(userId: string, limit: number = 50, offset: number = 0): Promise<any> {
		return new Promise((resolve, reject) => {
			if (!this.client) {
				return reject(new Error('gRPC client not initialized'));
			}
	...
	async updatePrivacySettings(userId: string, settings: any): Promise<any> {
		return new Promise((resolve, reject) => {
			...
			this.client.updatePrivacySettings(request, (error: any, response: any) => {
				if (error) {
	...
	async getPrivacySettings(userId: string): Promise<any> {
		return new Promise((resolve, reject) => {
			...
			this.client.getPrivacySettings({ user_id: userId }, (error: any, response: any) => {
				if (error) {
